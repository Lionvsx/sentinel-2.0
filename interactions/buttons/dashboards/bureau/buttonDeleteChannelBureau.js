...
module.exports = class DeleteChannelBureau extends BaseInteraction {
    constructor() {
        super('buttonDeleteChannelBureau', 'dashboards', 'button', {
            userPermissions: [],
            clientPermissions: []
        })
    }
    ...
    async run(client, interaction, buttonArgs) {
        ...
        const embed = new MessageEmbed()
            ...
            .setColor('2b2d31')
        const categoryOptions = getCategoryMenuOptions(allChannels.get('741991095155556363'))
